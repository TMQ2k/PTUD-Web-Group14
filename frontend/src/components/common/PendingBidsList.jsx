...
//  const [itemName, setItemName] = useState(productName);  
  ...
  //       const respone = await sellerApi.getBiddersPendingList(params.id);
  //       if (isMounted) {
  ...
  const handleRejectRequest = async (bidder_id) => {
    try {
  ...
  const handleRejectParticipant = async (bidder_id) => {
    try {
      //const reason = getValues(`reason-${bidder_id}`);
      //await sellerApi.rejectBidder(params.id, bidder_id, reason);
  ...
  return (
    <>      
      <div className="w-full mx-auto my-2 p-4 h-full">
        ...
        <div className="h-full py-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-linear-to-br from-blue-50 to-blue-100 rounded-3xl p-4 pr-1 shadow-xl border-4 border-blue-300/50">
                  ...
                  >
                    ...
                    <div className="flex flex-row justify-between items-center mb-2">
                      ...
                      <div className="flex flex-col justify-center gap-2">
                        ...
                        <button
                          onClick={() => handleRejectRequest(b.bidder_id)}
          ...
          <div className="bg-linear-to-br from-purple-50 to-purple-100 rounded-3xl p-4 pr-1 shadow-xl border-4 border-purple-300/50">
            ...
            <div className="max-h-[80vh] overflow-auto">
              {participants && participants.length > 0 && 
                participants.map((b) => (
                  <div
                    key={b.bidder_id}
                    className="bg-white/60 mb-2 mr-2 p-2 border-2 border-purple-200 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden"
                  >
                    {/* CARD CONTENT */}
                    <div className="flex flex-row justify-between items-center mb-2">
                      <div className=" flex flex-col gap-2 items-start justify-center">
                        ...
                        <div className="w-full">
                          <div className="flex flex-wrap items-center gap-2 mb-1">
                            <h3 className="font-semibold text-gray-900">
                              {b.bidder_username || b.masked_username}
                            </h3>
                            <span
                              className={`flex items-center gap-1 text-xs font-bold px-2 py-0.5 rounded-full ${
                                b.bidder_rating > 10
